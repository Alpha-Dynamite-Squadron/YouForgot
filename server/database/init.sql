...
-- Thu 29 Oct 2020 09:30:34 PM PDT
...
CREATE INDEX `fk_User_UserImage_idx` ON `yfdb`.`User` (`imageID` ASC);
...
CREATE INDEX `fk_SectionInstance_AcademicDiscipline` ON `yfdb`.`SectionInstance` (`disciplineLetters` ASC);

CREATE INDEX `fk_SectionInstance_Institution` ON `yfdb`.`SectionInstance` (`institutionID` ASC);

CREATE INDEX `fk_SectionInstance_Instructor` ON `yfdb`.`SectionInstance` (`instructorID` ASC);

CREATE INDEX `fk_SectionInstance_User` ON `yfdb`.`SectionInstance` (`sectionCreatorEmail` ASC);

CREATE INDEX `fk_SectionInstance_AcademicSessions` ON `yfdb`.`SectionInstance` (`academicSession` ASC);

CREATE INDEX `fk_SectionInstance_SectionImage_idx` ON `yfdb`.`SectionInstance` (`imageID` ASC);
